...
import { updateSupplier } from "@/lib/action/supplier"
import { updateSupplierSchema, UpdateSupplierInput } from "@/lib/validation/supplier"
...
export default function UpdateSupplierDialog(data: UpdateSupplierInput) {
    ...
    async function onSubmit(formData: UpdateSupplierInput) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="flex flex-col gap-4 bg-white text-black sm:max-w-xl">
                <DialogHeader>
                    <DialogTitle className="font-semibold">Update Supplier</DialogTitle>
                    <DialogDescription className="text-gray-400">Edit supplier details</DialogDescription>
                </DialogHeader>
